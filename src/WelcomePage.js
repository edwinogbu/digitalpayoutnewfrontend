...
import InvestArea from './components/InvestArea';
import { getMarketData } from './api';
import Footer from './components/Footer';
import TrendingCoin from './components/TrendingCoin';
import SupportService from './components/SupportService';
import PaymentHistoryArea from './components/PaymentHistoryArea';
    ...
    <div className="container"  style={{
        ...
        <div className="row">
            <div className="support-all">
                ...
                {/* How to Start */}
                <div className="col-md-12 col-sm-12 col-xs-12" >
                    <div className="support-services" style={{ backgroundImage: "linear-gradient(to bottom, rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('./images/fly-coins.jpg')" }}>
      ...
      <div className="blog-grid home-blog">
        ...
        <div className="col-md-4 col-sm-6 col-xs-12">
          <div className="single-blog">
            <div className="blog-image">
              <a className="image-scale" href="#">
                <img src="img/blog/b1.jpg" alt="Crypto Market Overview" />
              </a>
            </div>
            <div className="blog-content">
              <div className="blog-meta">
              ...
              <a href="#">
                <h4>Crypto Market Overview: Key Trends and Future Predictions</h4>
              </a>
        ...
        <div className="col-md-4 col-sm-6 col-xs-12">
          <div className="single-blog">
            <div className="blog-image">
              <a className="image-scale" href="#">
                <img src="img/blog/b2.jpg" alt="Bitcoin's Market Influence" />
              </a>
            </div>
            <div className="blog-content">
              <div className="blog-meta">
              ...
              <a href="#">
                <h4>How Bitcoin's Market Influence is Shaping Global Finance</h4>
              </a>
              <a href="#" className="read-more-btn">Read More</a>
            </div>
          </div>
        ...
        <div className="col-md-4 col-sm-6 col-xs-12">
          <div className="single-blog">
            <div className="blog-image">
              <a className="image-scale" href="#">
                <img src="img/blog/b3.jpg" alt="Decentralized Finance" />
              </a>
            </div>
            <div className="blog-content">
              <div className="blog-meta">
              ...
              <a href="#">
                <h4>The Rise of Decentralized Finance: What Investors Should Know</h4>
              </a>
              <a href="#" className="read-more-btn">Read More</a>
            </div>
          </div>
        ...
        <div className="col-md-4 col-sm-6 col-xs-12">
          <div className="single-blog">
            <div className="blog-image">
              <a className="image-scale" href="#">
                <img src="img/blog/b4.jpg" alt="Ethereum 2.0 Upgrade" />
              </a>
            </div>
            <div className="blog-content">
              <div className="blog-meta">
              ...
              <a href="#">
                <h4>Ethereum 2.0: What the Upgrade Means for the Future of Crypto</h4>
              </a>
              <a href="#" className="read-more-btn">Read More</a>
            </div>
          </div>
        ...
        <div className="col-md-4 col-sm-6 col-xs-12">
          <div className="single-blog">
            <div className="blog-image">
              <a className="image-scale" href="#">
                <img src="img/blog/b5.jpg" alt="Regulatory Challenges in Crypto" />
              </a>
            </div>
            <div className="blog-content">
              <div className="blog-meta">
              ...
              <a href="#">
                <h4>Regulatory Challenges and Their Impact on Crypto Markets</h4>
              </a>
              <a href="#" className="read-more-btn">Read More</a>
            </div>
          </div>
        ...
        <div className="col-md-4 col-sm-6 col-xs-12">
          <div className="single-blog">
            <div className="blog-image">
              <a className="image-scale" href="#">
                <img src="img/blog/b6.jpg" alt="Altcoins to Watch in 2024" />
              </a>
            </div>
            <div className="blog-content">
              <div className="blog-meta">
